...
namespace Orchestrix.Admin.Api
{
  public class Program
  {
    public static void Main(string[] args)
    {
      ...
      {
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "Orchestrix Public API", Version = "v1" });
        ...
        c.AddServer(new OpenApiServer { Url = "https://localhost:27443" });
      });
      ...
      app.UseCors(options =>
      {
        options.WithOrigins(["https://localhost:27443", "http://localhost:27000"]);
      ...
      if (app.Environment.IsDevelopment())
      {
        ...
        app.UseSwaggerUI(c =>
        {
          c.SwaggerEndpoint("/api/v1/swagger/v1/swagger.json", "Orchestrix.Public.Api v1");
